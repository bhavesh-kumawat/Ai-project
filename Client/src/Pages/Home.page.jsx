      ...
      >
        ...
        <ul className="space-y-3 mt-auto">
          {features.map((f, i) => (
            ...
            >
              <span
                className={`text-base ${popular ? "text-violet-400" : "text-emerald-400"}`}
              >
                ✓
              </span>
              {f}
    ...
    <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/login"
              className="hidden md:block text-sm text-white/60 hover:text-white transition-colors px-4 py-2"
            >
              Sign In
            </Link>
            <MotionLink
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-24">
          ...
          >
            Transform your ideas into professional animations and cinematic
            videos with our next-generation AI platform. No experience needed.
          </motion.p>
          ...
          >
            ...
            <MotionLink
              to="/login"
              className="bg-gradient-to-r from-violet-600 to-pink-600 hover:from-violet-500 hover:to-pink-500 text-white text-sm font-bold px-5 py-2 rounded-full text-base flex items-center gap-2 shadow-lg shadow-violet-900/50 transition-all"
              whileHover={{
                scale: 1.04,
          ...
          <FadeUp>
            <div className="text-center mb-16">
              ...
              <p className="text-white/40 mt-4 text-lg">
                Everything you need to create professional media with AI
              </p>
            </div>
          </FadeUp>
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 50% at 50% 50%, #7c3aed15, transparent)",
          }}
        />
        <div className="max-w-5xl mx-auto">
          <FadeUp>
            <div className="text-center mb-12">
              ...
              <p className="text-white/40 mt-4 text-lg">
                Type your idea, choose a style, and watch AI bring it to life
              </p>
            </div>
          </FadeUp>
                    ...
                    {error && (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="mt-4 text-xs text-violet-400 hover:text-violet-300 font-bold"
                        >
                          Try Again
                        </button>
                      </motion.div>
                    ...
                    {generated && (
                      ...
                      >
                        ...
                        <p className="text-white/40 text-sm text-center">
                          Your cinematic video has been generated successfully
                        </p>
      ...
      <section id="pricing" className="py-24 px-6 relative">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 40% at 50% 100%, #7c3aed12, transparent)",
          }}
        />
        <div className="max-w-5xl mx-auto">
          <FadeUp>
          ...
          <FadeUp>
            <div className="relative rounded-3xl overflow-hidden p-12 text-center border border-violet-500/30">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #7c3aed22 0%, #ec489922 50%, #06b6d422 100%)",
                }}
              />
              <motion.div
                className="absolute inset-0"
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/50 text-lg mb-8">
                  Join 500,000+ creators already using AnimateX to bring their
                  ideas to life.
                </p>
                {/* <motion.button
                ...
                <MotionLink
                  ...
                  whileHover={{
                    scale: 1.06,
                    boxShadow: "0 25px 50px rgba(124,58,237,0.45)",
                  }}
                  whileTap={{ scale: 0.97 }}
                >
                  ▶ Start Creating Free — No Credit Card
        ...
        <div className="max-w-7xl mx-auto">
          <FadeUp>
            <div className="text-center mb-16">
              ...
              <p className="text-white/40 mt-4 text-lg">
                Everything you need to know about AnimateX
              </p>
            </div>
          </FadeUp>
            ...
            {[
              ...
              <FadeUp key={i} delay={i * 0.1}>
                <div className="p-8 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm">
                  <h3 className="text-violet-400 font-bold mb-6 uppercase tracking-widest text-xs">
                    {cat.title}
                  </h3>
                  <ul className="space-y-4">
                    {cat.items.map((item, j) => (
                      <li key={j}>
                        ...
                        >
                          <span className="w-1.5 h-1.5 rounded-full bg-violet-600 group-hover:scale-150 transition-transform" />
                          {item}
                        </a>
                      </li>
                    ))}
      ...
      <section
        id="about"
        className="py-24 px-6 relative bg-white/5 backdrop-blur-sm"
      >
        <div className="max-w-4xl mx-auto">
          <FadeUp>
            <p className="text-violet-400 text-sm font-bold uppercase tracking-widest mb-3">
            ...
            <p className="text-2xl text-violet-400 mb-8 leading-relaxed font-bold">
              We believe that high-quality visual storytelling should be
            ...
            <div className="space-y-8 text-white/60 text-lg leading-relaxed">
              <p>
                AnimateX was founded in 2024 by a team of AI researchers and
                visual artists who saw the potential of generative models to
                revolutionize the creative industry. We realized that while AI
                was getting better at generating images, the jump to temporal
                consistency in video was still a major hurdle.
              </p>
              <p>
                Our team spent two years developing a proprietary neural
                rendering engine that understands motion, physics, and lighting
                at a fundamental level. This allows our users to generate
          ...
          >
            <div>
              ...
              <div className="text-white/40 text-sm italic">Founded</div>
            </div>
            <div>
              <div className="text-4xl font-black text-white mb-2">500k+</div>
              <div className="text-white/40 text-sm italic">Creators</div>
            </div>
            <div>
              <div className="text-4xl font-black text-white mb-2">10M+</div>
              <div className="text-white/40 text-sm italic">Videos Gen</div>
            </div>
            <div>
              <div className="text-4xl font-black text-white mb-2">45</div>
              <div className="text-white/40 text-sm italic">Team Members</div>
            </div>
          </FadeUp>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 lg:gap-32">
          <FadeUp>
            ...
            <p className="text-white/50 text-xl mb-12 max-w-md">
              Have a question about our platform, enterprise solutions, or just
          ...
          <FadeUp delay={0.2}>
            <form className="space-y-6 bg-white/5 p-10 rounded-3xl border border-white/10 backdrop-blur-xl">
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest font-black text-white/40">
                    First Name
                  </label>
                  <input
                    type="text"
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:border-violet-500 outline-none transition-colors"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest font-black text-white/40">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  rows="5"
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:border-violet-500 outline-none transition-colors resize-none"
                ></textarea>
              </div>
              <button className="w-full bg-violet-600 hover:bg-violet-500 text-white font-black py-4 rounded-xl transition-all shadow-lg shadow-violet-900/40">
                Send Message
              </button>
            </form>
          </FadeUp>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-12">
            <div className="col-span-2">
              ...
              <p className="text-white/40 text-sm leading-relaxed max-w-xs">
                ...
                creative vision to life with the power of artificial
                intelligence.
              </p>
            </div>
            {[
